# Generated by Django 4.0.8 on 2022-11-10 15:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('gel_nail', 'Gel nail'), ('kapping_nail', 'Kapping nail'), ('acrylic_nail', 'Acrylic nail'), ('lifting', 'Lifting lashes'), ('extension', 'Extension lashes'), ('perfilado_cejas', 'Perfilado de cejas'), ('threading_cejas', 'Threading de cejas'), ('facial', 'Tratamiento facial')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeslot', models.IntegerField(choices=[(1, '10:00 - 10:30'), (2, '10:30 - 11:00'), (3, '11:00 - 11:30'), (4, '11:30 - 12:00'), (5, '12:00 - 12:30'), (6, '12:30 - 13:00'), (7, '13:00 - 13:30'), (8, '13:30 - 14:00'), (9, '14:00 - 14:30'), (10, '14:30 - 15:00'), (11, '15:00 - 15:30'), (12, '15:30 - 16:00'), (13, '16:00 - 16:30'), (14, '16:30 - 17:00'), (15, '17:00 - 17:30'), (16, '17:30 - 18:00'), (17, '18:00 - 18:30')], default='Elija el horario', null=True)),
