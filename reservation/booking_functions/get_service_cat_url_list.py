...
def get_service_cat_url_list():
    ...
    service_categories=dict(service.SERVICE_CATEGORIES) # Hago un diccionario a partir de la tupla "SERVICE CATEGORIES" en la clase "Servicio"
    service_cat_url_list=[] # Lista para guardar Servicios en el formato (categoria,URL)
